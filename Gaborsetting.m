...
% scale_h=3;
% Gabor parameter
par.ds_w       =    24;       % the downsample image's width in Gabor
par.ds_h       =    24;       % the downsample image's heigth in Gabor
par.ke_w       =    11;             % Gabor kernel's width
par.ke_h       =    11;             % Gabor kernel's heigth
...
par.sigma      =    1.5*pi;             % Gabor kernel's para, default(pi or 1.5pi)
par.Gabor_num  =    32;             % Gabor kernel's number, default (4 scales and 8 orientations)
